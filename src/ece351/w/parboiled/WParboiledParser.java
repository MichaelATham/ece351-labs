...
public /*final*/ class WParboiledParser extends BaseParser351 {
	...
	@Override
    public Rule Program() {
        return Sequence(push(new WProgram()), OneOrMore(Waveform()),EOI);
    }
    ...
    public Rule Waveform() {
        return Sequence(W0(), Name(), push(new Waveform(match())), W0(),':', W0(), BitString(), W0(),';', W0(), swap(), push(((WProgram)pop()).append(((Waveform)pop()))));
    }
     ...
     */
    public Rule Name() {
        return Sequence(W0(), Letter(), ZeroOrMore(FirstOf(Letter(), CharRange('0', '9'), Ch('_'))));
    }
    ...
    public Rule BitString() {
        return Sequence(W0(), Bit(), ZeroOrMore(W0(), Bit()), W0());
    }
     ...
     */
    public Rule Bit() {   
        return Sequence(FirstOf('0','1'), push(((Waveform)pop()).append(match())));
    }
