...
public final class Waveform implements Examinable {
	...
	public String toString() {
		String bits = String.join(" ", this.bits); 	// Joins each bit together into one string, separated by the delimiter " "
		return this.name + " : " + bits + ";";					// Returns the waveforms in their W format
	}
